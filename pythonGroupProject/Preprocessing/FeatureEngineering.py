...
class FeatureEngineering:
    ...
    def go(self):
        self.trainingData = self.featureEngineer(self.trainingData)
        self.testingData = self.featureEngineer(self.testingData)
    ...
    def featureEngineer(self, all_data):
        ...
        all_data[
            'TotalExtraPoints'] = all_data.HeatingQC + all_data.PoolQC + all_data.FireplaceQu + all_data.KitchenQual
        all_data['TotalPoints'] = (
                                              all_data.ExterQual + all_data.FireplaceQu + all_data.GarageQual + all_data.KitchenQual +
        ...
        df = all_data.loc[
            (all_data.SalePrice > 0), ['TotalPoints', 'TotalExtraPoints', 'OverallQual', 'OverallCond', 'ExterQual',
                                       'ExterCond', 'BsmtQual',
